...
class TurkeyUniversityController extends Controller
{
    public function listTurkeyUniversity()
    {
        $universities = TrUniversity::all();
        return view('admin.university-list', compact('universities'));
    }

    public function showTurkeyUniversity($id)
    {
        try {
    ...
    public function updateTurkeyUniversity(Request $request, $id)
    {
    ...
    protected function updateSection(Request $request, $university, $sectionId)
    {
        ...
        try {
            ...
            if ($request->has('lists')) {
                ...
                $existingItems = TrUniversityList::where('tr_university_id', $university->id)
            ...
            if ($request->hasFile('images')) {
                foreach ($request->file('images') as $image) {
                    ...
                    TrUniversityImages::create([
                        'tr_university_id' => $university->id,
                        'section_id' => $section->id,
    ...
    public function deleteTurkeyUniversity($id)
    {
        $university = TrUniversity::findOrFail($id);
        $university->delete();
