...
use App\Http\Controllers\Admin\TurkeyUniversityController;
use App\Http\Controllers\Admin\GermanyUniversityController;
use App\Http\Controllers\Admin\CAnadaUniversityController;
use App\Http\Controllers\Admin\UnitedKingdomUniversityController;
...
Route::get('/admin/university/turkey/list', [TurkeyUniversityController::class, 'listTurkeyUniversity'])->name('admin.university.turkey.list');
Route::get('/admin/universities/turkey/{id}/edit', [TurkeyUniversityController::class, 'showTurkeyUniversity'])->name('admin.university.turkey.edit');
Route::put('/admin/universities/turkey/{id}', [TurkeyUniversityController::class, 'updateTurkeyUniversity'])->name('admin.university.turkey.update');
Route::delete('/admin/universities/turkey/{id}', [TurkeyUniversityController::class, 'deleteTurkeyUniversity'])->name('admin.university.turkey.delete');

Route::get('/admin/university/germany/list', [GermanyUniversityController::class, 'listGermanyUniversity'])->name('admin.university.germany.list');
Route::get('/admin/universities/germany/{id}/edit', [GermanyUniversityController::class, 'showGermanyUniversity'])->name('admin.university.germany.edit');
Route::put('/admin/universities/germany/{id}', [GermanyUniversityController::class, 'updateGermanyUniversity'])->name('admin.university.germany.update');
Route::delete('/admin/universities/germany/{id}', [GermanyUniversityController::class, 'deleteGermanyUniversity'])->name('admin.university.germany.delete');

Route::get('/admin/university/canada/list', [CanadaUniversityController::class, 'listCanadaUniversity'])->name('admin.university.canada.list');
Route::get('/admin/universities/canada/{id}/edit', [CanadaUniversityController::class, 'showCanadaUniversity'])->name('admin.university.canada.edit');
Route::put('/admin/universities/canada/{id}', [CanadaUniversityController::class, 'updateCanadaUniversity'])->name('admin.university.canada.update');
Route::delete('/admin/universities/canada/{id}', [CanadaUniversityController::class, 'deleteCanadaUniversity'])->name('admin.university.canada.delete');

Route::get('/admin/university/united-kingdom/list', [UnitedKingdomUniversityController::class, 'listUnitedKingdomUniversity'])->name('admin.university.united.kingdom.list');
Route::get('/admin/universities/united-kingdom/{id}/edit', [UnitedKingdomUniversityController::class, 'showUnitedKingdomUniversity'])->name('admin.university.united.kingdom.edit');
Route::put('/admin/universities/united-kingdom/{id}', [UnitedKingdomUniversityController::class, 'updateUnitedKingdomUniversity'])->name('admin.university.united.kingdom.update');
Route::delete('/admin/universities/united-kingdom/{id}', [UnitedKingdomUniversityController::class, 'deleteUnitedKingdomUniversity'])->name('admin.university.united.kingdom.delete');
...
Route::get('/project-management', function () {
    return view('admin.project-management');
});
